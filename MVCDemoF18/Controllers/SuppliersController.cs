    ...
    public class SuppliersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ViewData["Products"] = new SelectList(
                _context.Product.OrderByDescending(p => p.Name).ToList(), "ProductID", "Name"
           );
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Location,ProductID")] Supplier supplier)
        {
